...
Jeu de référence : **32** questions dans le périmètre, **5** hors périmètre. Durée totale : 2.6 min.
...
|---|---|---|
| 2 — Citation systématique | réponses citant ≥ 1 article | **94%** (30/32) |
| 3 — Abstention correcte | questions hors périmètre refusées | **100%** (5/5) |
| 5 — Vérification des citations | articles cités présents dans le contexte | **96%** (44/46) |
| — *(bonus)* Justesse de la source | l'article attendu est cité | **81%** (26/32) |
| — Abstentions à tort | questions valides refusées | **0/32** |
...
- **Dans quel délai faut-il saisir le tribunal après un licenciement contesté ?**  
  attendu : 65 · cité : 532
- **Combien de jours de congé annuel payé acquiert-on par mois de service ?**  
  attendu : 231 · cité : 235
...
| Dans quel délai faut-il saisir le tribunal après un licenciement contesté ? | retrieval | 65 | 532 | non |
...
| Peut-on employer un mineur de moins de 18 ans dans les mines ? | retrieval | 179 | 179 | non |
| Combien d'heures par mois un délégué des salariés a-t-il pour exercer ses fonctions ? | retrieval | 456 | 456 | non |
| Quelles catégories de salariés sont régies par des statuts spéciaux ? | retrieval | 3 | 3 | non |
| Pour combien de temps peut-on conclure un CDD à l'ouverture d'une nouvelle entreprise ? | retrieval | 17 | 17 | non |
| Combien de jours de congé annuel payé acquiert-on par mois de service ? | retrieval | 231 | 235 | non |
...
| Quelles sont les fautes graves pouvant justifier le licenciement d'un salarié ? | retrieval | 39 | 39, 40 | non |
| Comment sont calculés les dommages-intérêts en cas de licenciement abusif ? | retrieval | 41 | 41, 59 | non |
| Comment est calculée l'indemnité de licenciement ? | retrieval | 53 | 53, 55, 56, 59 | non |
...
| À partir de combien de salariés un comité de sécurité et d'hygiène est-il obligatoire ? | retrieval | 336 | — | non |
...
| Quelles obligations de sécurité et de santé l'employeur a-t-il envers ses salariés ? | retrieval | 24, 281 | 24, 169, 287, 504, 542 | non |
